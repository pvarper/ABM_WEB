...
import support.user.business.ParametroCompBL;
...
@ManagedBean
@ViewScoped
public class ParametroFormComp implements Serializable,IControlPrivilegios {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ParametroFormComp.class);
	private static final int EXIT_ERROR=0;
	private static final int EXIT_OK=1;

	@Inject
	private ParametroCompBL parametroBL;
	...
	public boolean isAuthorized(int idAccion) {
		return controlPrivilegio.isAuthorized(FormularioID.FORM_GEST_PARAMETROS_COMP, idAccion);
	}
