...
public class P {
	 ...
	 * @see support.id.ParametroID
	 * */
	public static  Parametro getParametro(Integer idParametro){
			try {
	 ...
	 * @see support.id.ParametroID
	 * */
	public static  Object getParamVal(Integer idParametro){
		try {
	...
	private static HashMap<Integer, Parametro> cargarParametros() throws SQLException{
			...
			if(inicializarListaParametros()==null){
	...
	public static synchronized HashMap<Integer,Parametro> inicializarListaParametros(){
