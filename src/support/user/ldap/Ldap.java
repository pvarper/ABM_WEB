...
//		return mapa;
	...
	@SuppressWarnings("rawtypes")
	public Map<String, String> obtenerDatosPorNombre(String usuarioE, String[] datosReturn) throws Exception {
		Map<String, String> mapa = new HashMap<String, String>();
		try {
			this.ctx = new InitialLdapContext(this.env, null);
...
//		return mapa;
	...
	@SuppressWarnings("rawtypes")
	public Map<String, String> obtenerDatosPorEH(String usuarioE, String[] datosReturn) throws Exception {
		Map<String, String> mapa = new HashMap<String, String>();
		try {
			this.ctx = new InitialLdapContext(this.env, null);
