...
@ManagedBean
@ViewScoped
public class AreaBeanPla implements Serializable, IControlPrivilegios {
	private static final long serialVersionUID = 1L;
	public static Logger log = Logger.getLogger(AreaBeanPla.class);
	...
	public void init() {
		try {
			...
			this.listPlat = this.platBL.getListArea();
...
//		}
//		
		String str = this.platBL.validatePla(this.pla, this.plaId);
		if (!str.isEmpty()) {
			SysMessage.warn(str);
			return;
		}
